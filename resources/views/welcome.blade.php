...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Alpha Omega Academy</title>
    ...
    <body>
            ...
            <div class="fname"> Smart Card-based Food 
                <br> <br> Monitoring System</div>
            @endif
        </div>
    </body>
</html>
